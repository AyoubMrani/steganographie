...
class SteganographyApp:
    def __init__(self, root):
        ...
        self.root.geometry("800x700")  # Increased height for additional controls
        ...
        self.notebook.add(self.hide_tab, text="Hide File(s)")
        self.notebook.add(self.extract_tab, text="Extract File(s)")
    ...
    def setup_hide_tab(self):
        ...
        # Title
        title_label = tk.Label(main_frame, text="Hide File(s) in Image", 
        ...
        left_frame = tk.LabelFrame(content_frame, text="Carrier Image", bg="#f0f2f5", padx=10, pady=10)
        ...
        select_image_btn = tk.Button(left_frame, text="Select Image", 
        ...
        # Image capacity info
        self.image_capacity_label = tk.Label(left_frame, text="Capacity: Unknown", 
                                           bg="#f0f2f5")
        self.image_capacity_label.pack(pady=5)
        
        # Right frame for file(s)
        right_frame = tk.LabelFrame(content_frame, text="File(s) to Hide", bg="#f0f2f5", padx=10, pady=10)
        ...
        select_file_btn = tk.Button(self.single_file_frame, text="Select File", 
        ...
        self.capacity_usage_label = tk.Label(self.capacity_usage_frame, text="Capacity Usage:", bg="#f0f2f5")
        ...
        # Add files button
        add_files_btn = tk.Button(files_buttons_frame, text="Add Files", 
                                 command=self.add_files,
                                 bg="#4f46e5", fg="white", padx=10, pady=5)
        add_files_btn.pack(side=tk.LEFT, padx=5)
        
        # Remove selected button
        remove_file_btn = tk.Button(files_buttons_frame, text="Remove Selected", 
                                   command=self.remove_selected_file,
                                   bg="#ef4444", fg="white", padx=10, pady=5)
        remove_file_btn.pack(side=tk.LEFT, padx=5)
        
        # Clear all button
        clear_files_btn = tk.Button(files_buttons_frame, text="Clear All", 
        ...
        output_frame = tk.LabelFrame(main_frame, text="Output Directory", bg="#f0f2f5", padx=10, pady=10)
        ...
        browse_btn = tk.Button(output_frame, text="Browse", 
        ...
        # Password frame
        self.password_frame = tk.LabelFrame(main_frame, text="Security", bg="#f0f2f5", padx=10, pady=10)
        ...
        # Hide file button
        self.hide_btn = tk.Button(buttons_frame, text="Hide File(s) in Image", 
    ...
    def setup_extract_tab(self):
        ...
        # Title
        title_label = tk.Label(main_frame, text="Extract Hidden File(s)", 
                              font=("Helvetica", 16, "bold"), bg="#f0f2f5")
        title_label.pack(pady=(0, 20))
        
        # Image frame
        image_frame = tk.LabelFrame(main_frame, text="Image with Hidden Data", bg="#f0f2f5", padx=10, pady=10)
        ...
        # Image selection button
        select_extract_image_btn = tk.Button(image_frame, text="Select Image", 
        ...
        # Password frame
        extract_password_frame = tk.LabelFrame(main_frame, text="Security", bg="#f0f2f5", padx=10, pady=10)
        ...
        extract_status_label = tk.Label(extract_status_frame, textvariable=self.extract_status, bg="#f0f2f5")
    ...
    def hide_file_in_image(self, file_path, image_path, output_path, password="mysecret"):
        ...
        file_bits, file_bytes_length = self.file_to_bits(file_path)
